...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AutomaticLogin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14AutomaticLogin11AppDelegate")
...
SWIFT_CLASS("_TtC14AutomaticLogin13SceneDelegate")
...
SWIFT_CLASS("_TtC14AutomaticLogin14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(AutomaticLogin)) <WKNavigationDelegate, WKScriptMessageHandler, WKUIDelegate>
